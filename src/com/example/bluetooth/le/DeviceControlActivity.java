...
public class DeviceControlActivity extends Activity {
    ...
    private void setAdcTimeStatus(byte high, byte low){
    	...
    	if((high == 0) && (low == 0)){
    		...
    		tvadc0.setText("0x00"+"  Hex");
    		tvadc1.setText("0x00"+"  Hex");
    ...
    private void updateADC0(byte value){
    	tvadc0.setText("0x"+bytesToHex(value)+"  Hex");
    }
    private void updateADC1(byte value){
    	tvadc1.setText("0x"+bytesToHex(value)+"  Hex");
    }
